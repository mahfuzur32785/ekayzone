...
import 'package:ekayzone/modules/ads/component/customer_ad_card_list.dart';
...
import 'component/customer_ads_card.dart';
          ...
          SliverToBoxAdapter(
              child: BlocConsumer<CustomerAdsBloc, CustomerAdsState>(
                ...
                builder: (context, state) {
                  ...
                  if (customerAdsBloc.adList.isEmpty && state is CustomerAdsStateLoading) {
                    return SizedBox(
