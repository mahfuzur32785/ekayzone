...
import 'package:ekayzone/modules/payment_gateway/controllers/stripe/stripe_cubit.dart';
import 'package:ekayzone/modules/payment_gateway/stripe/stripe_service.dart';
import 'package:ekayzone/modules/price_planing/component/payment_card_card.dart';
...
class _PlanDetailsScreenState extends State<PlanDetailsScreen> {
  ...
  void initState() {
    ...
    super.initState();
    Future.microtask(
        () => context.read<PaymentGatewayCubit>().getPaymentGateways());
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children:  [
                                    ...
                                    Expanded(flex: 3,child: SizedBox(child: Text("R${widget.price}.00",maxLines: 1,overflow: TextOverflow.ellipsis,)))
                                  ],
                                ),
                              ),
                            ],
                ...
                SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate((context, index) {
                      ...
                      else if (state.gatewaysResponseModel.gateways[index]
                          .contains("payfast")) {
                        return PaymentMethodCard(
                          title: 'Pay with PayFast',
                          icon: Kimages.payFastIcon,
                          press: () {
                            Navigator.pushNamed(
                                context, RouteNames.payfastScreen, arguments: PayfastPaymentArguments(widget.adDetails, widget.id, widget.title, widget.price)).then((value) => Navigator.pop(context));
                          },
                          // press: () {
