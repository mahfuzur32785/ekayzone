...
import 'package:ekayzone/modules/authentication/models/user_login_response_model.dart';
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                "${state.data.ratingDetails.rating} ${AppLocalizations.of(context).translate('star_rating')}",
                                style: const TextStyle(
                          ...
                          Text(
                            "${AppLocalizations.of(context).translate('follow_on_social_media')}",
                            style: const TextStyle(
                                color: Colors.black54,
                                fontSize: 14,
                                fontWeight: FontWeight.w400),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text("${state.data.ratingDetails.average} ${AppLocalizations.of(context).translate('star_average_rating')}",style: const TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w500),),
                                      Text("${state.data.reviewList.length} ${AppLocalizations.of(context).translate('people_written_reviews')}",style: const TextStyle(color: Colors.black54,fontSize: 14,fontWeight: FontWeight.w400),),
                                    ],
                                  ),
                                )
                              ],
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text("${AppLocalizations.of(context).translate('active_ads')}",style: const TextStyle(color: Colors.black54,fontSize: 14,fontWeight: FontWeight.w400),),
                                    ],
                                  ),
                                ),
                                const SizedBox(
                                ...
                                child: Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text("${AppLocalizations.of(context).translate('recent_ads')}",style: TextStyle(color: isAds == 1 ? Colors.white :  Colors.black,fontSize: 15,fontWeight: FontWeight.w500),),
                                    ),
                                  ),
                                ),
                              ),
                                ...
                                child: Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      padding: const EdgeInsets.symmetric(vertical: 16.0,horizontal: 8),
                                      child: Text("${AppLocalizations.of(context).translate('seller_review')}",style: TextStyle(color: isAds != 1 ? Colors.white : Colors.black,fontSize: 15,fontWeight: FontWeight.w500),),
                                    ),
                                  ),
                                ),
                              ),
                                                  ...
                                                  onPressed: () async {
                                                    if (userData != null) {
                                                      if (rating > -1 && reviewController.text != '') {
                                                        ...
                                                        final result = await bloc.profileRepository.postSellerReview(body, state.data.user.username, userData.accessToken);
                                                        result.fold((l) {
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child: CustomImage(
                                                          // path: RemoteUrls.imageUrl(productModel.image),
                                                            path: state.data.reviewList[index].user.image != '' ? '${RemoteUrls.rootUrl2}${state.data.reviewList[index].user.image}' : null,
                                                            fit: BoxFit.cover
                                                        ),
                                                      ),
                                                    ),
