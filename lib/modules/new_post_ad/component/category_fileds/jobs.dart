  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Text("${AppLocalizations.of(context).translate('job_type')}",style: const TextStyle(fontSize: 16),),
        const SizedBox(
          height: 7,
        ),
        DropdownButtonFormField(
          ...
          decoration: InputDecoration(
            hintText: "${AppLocalizations.of(context).translate('Select job Type')}",
          ),
            ...
            return Visibility(
              ...
              child: AnimatedOpacity(
                ...
                child: Column(
                  ...
                  children: [
                    Text("${AppLocalizations.of(context).translate('Employer Email')}",style: const TextStyle(fontSize: 16),),
                    const SizedBox(
                      height: 7,
                    ),
                    BlocBuilder<NewPostAdBloc, NewPostAdModalState>(
        ...
        DropdownButtonFormField(
          ...
          // },
          decoration: InputDecoration(
            hintText: "${AppLocalizations.of(context).translate('Select Education')}",
          ),
        ...
        Row(
          children: [
            Expanded(
              child: Text("${AppLocalizations.of(context).translate('From')}",style: const TextStyle(fontSize: 16),),
            ),
            Expanded(
              child: Text("${AppLocalizations.of(context).translate('to')}",style: const TextStyle(fontSize: 16),),
            )
          ],
        ),
        const SizedBox(
